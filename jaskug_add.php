  ...
  <main>
    <div class="container-fluid px-4">
      ...
      <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="jaskug_tabel.php">Table</a></li>
        <li class="breadcrumb-item active">Form Input Jaskug</li>
      </ol>
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
  <form action="jaskug_proses.php?aksi=insert" method="POST">
