...
if ($aksi == 'insert') {
    ...
    $insert = $conn->query('INSERT INTO progres 
                        ...
                        ("'.$bagian.'","'.$modul.'","'.$status.'","'.$keterangan.'","'.$persentase.'","'.$due_date.'")');
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "jaskug_tabel.php"</script>';
    } else {
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "jaskug_tabel.php"</script>';
    } else {
...
// HAPUS DATA
    ...
    if ($hapus) {
        echo '<script>alert("Data berhasil dihapus");location.href = "jaskug_tabel.php"</script>';
    } else {
