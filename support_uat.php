...
<div class="container mt-4 mb-4">
  <center>
  <div>
  <button type="button" class="btn" style="width:90px; background-color:#ccff33;"><a  href="support_initiation.php">Initiation</a></button>
  <button type="button" class="btn" style="width:90px; background-color:#9ef01a;"><a  href="support_coding.php">Coding</a></button>
  <button type="button" class="btn" style="width:90px; background-color:#70e000;"><a  href="support_testing.php">Testing</button>
  <button type="button" class="btn" style="width:90px; background-color:#38b000;"><a  href="support_uat.php">UAT</button>
  <button type="button" class="btn" style="width:90px; background-color:#008000;"><a  href="support_complete.php">Complete</button>
  <button type="button" class="btn" style="width:90px; background-color:yellow;"><a  href="support_onhold.php">Onhold</button>  
  <button type="button" class="btn" style="width:90px; background-color:red;"><a  href="support_returned.php">Returned</button>
  </div>
  </center>  
</div>
...
<!-- Masing - masing Status -->
    <div class="container">
        ...
        $data = mysqli_query($koneksi,"SELECT * FROM progres WHERE status=4 AND bagian=1");
        $jumlah_data = mysqli_num_rows($data);
        $total_halaman = ceil($jumlah_data / $batas);

        $data = mysqli_query($koneksi,"SELECT * FROM progres WHERE status=4 AND bagian=1 limit $halaman_awal, $batas");
