                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Kurlog Status UAT</li>
                        </ol>
...
<!-- Masing - masing Status -->
    <div class="container">
        ...
        $data = mysqli_query($koneksi,"SELECT * FROM progres WHERE status=4 AND bagian=3");
        $jumlah_data = mysqli_num_rows($data);
        $total_halaman = ceil($jumlah_data / $batas);

        $data = mysqli_query($koneksi,"SELECT * FROM progres WHERE status=4 AND bagian=3 limit $halaman_awal, $batas");
