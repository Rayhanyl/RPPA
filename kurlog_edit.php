  ...
  <main>
    <div class="container-fluid px-4">
      ...
      <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="kurlog_tabel.php">Tabel</a></li>
        <li class="breadcrumb-item active">Form Edit Kurlog</li>
      </ol>
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
  <form action="kurlog_proses.php?aksi=update&id=<?= $_GET['id'] ?>" method="POST">
<!--   <div class="form-group">
    <label for="bagian">Bagian</label>
     <select class="form-control" name='bagian' required>
        <option value="<?= $row['bagian'] ?>"></option>
        <option value="">-- Pilih Bagian --</option>
        <option value="3">Kurlog</option>
      </select>
  </div> -->
  <input type="name" name="bagian" value="3" hidden>
  <div class="form-group">
