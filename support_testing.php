...
<!-- Masing - masing Status -->
    <div class="container">
        ...
        $data = mysqli_query($koneksi,"SELECT * FROM progres WHERE status=3 AND bagian=1");
        $jumlah_data = mysqli_num_rows($data);
        $total_halaman = ceil($jumlah_data / $batas);

        $data = mysqli_query($koneksi,"SELECT * FROM progres WHERE status=3 AND bagian=1 limit $halaman_awal, $batas");
